...
function updateOrderMethodCost() {
    ...
    if (method === 'delivery') {
        if (totalDays < 7) {
            ...
            document.getElementById('order-cost').textContent = 'Biaya Metode Pemesanan Rp2000 x ' + totalDays + ' = Rp' + orderMethodCost;
        } else if (totalDays < 30) {
            orderMethodCost = 1500 * totalDays;
            document.getElementById('order-cost').textContent = 'Biaya Metode Pemesanan: Rp1500 x ' + totalDays + ' = Rp' + orderMethodCost;
        } else {
            orderMethodCost = 1000 * totalDays;
            document.getElementById('order-cost').textContent = 'Biaya Metode Pemesanan: Rp1000 x ' + totalDays + ' = Rp' + orderMethodCost;
        }
    } else if (method === 'outlet') {
        orderMethodCost = 0;
        document.getElementById('order-cost').textContent = 'Biaya Metode Pemesanan: Rp0 x ' + totalDays + ' = Rp' + orderMethodCost;
    } else if (method === ''){
        orderMethodCost = 0;
